...
// this modifie values each time a button is clicked
...
// thisfunction updates the screen with the contents of Display_Value
...
keys.addEventListener('click', (event) => {
    //the target vaiable is an object that represents the element
    // that was clicked
    const { target } = event;
